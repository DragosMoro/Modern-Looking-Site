      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3r45]">
        ...
        <div className="flex flex-row md:mt-0 mt-6">
          {socialMedia.map((social, index) => (
            <img key={social.id} src={social.icon} alt="social_media" className={`w-[21px] h-[21px] object-contain cursor-pointer ${index !== social.length -1 ? 'mr-6' : 'mr-0'} hover:brightness-75 transition duration-300`}/>
          ))}
